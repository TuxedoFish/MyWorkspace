...
public class GenrealRenderer {
	...
	private FloatBuffer emptymatrixfb = BufferUtils.createFloatBuffer(16);
	
	public GenrealRenderer() {
		emptymatrixfb.clear();
		emptymatrix.store(emptymatrixfb);
		emptymatrixfb.flip();
	}
	public void renderLineCollection(LineCollection lc, ShaderHandler sh, DisplaySetup d, Controller parent) {
		...
		glUniformMatrix4(modelmatrixloc, false, emptymatrixfb);
