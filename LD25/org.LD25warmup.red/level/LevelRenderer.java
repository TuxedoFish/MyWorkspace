...
public class LevelRenderer {
	...
	public FloatBuffer getBlock(int texid, Vector2f pos, TextureHolder th) {
		Vector2f realpos = (pos);
		Vector2f[] texturecoords = th.getTextureCoords(texid);
		
		final Block b = new Block();
		final Vector2f size = getRealLengths(new Vector2f(b.getWidth(), b.getHeight()));
	...
	public void render(LevelHolder lh, ShaderHandler sh, TextureHolder th,ArrayList<Block> blocks, DisplaySetup d) {
		...
		util.setup(lh.getData(), lh.getVaoid(), lh.getVboid(), sh, th.getTexid(), 2, getIndices(blocks, d));
